...
MAINTAINER ER <47130084+colorfulsing@users.noreply.github.com>
...
LABEL "version"="1.2.3"
LABEL "repository"="http://github.com/colorfulsing/rust-release.action"
LABEL "maintainer"="ER <47130084+colorfulsing@users.noreply.github.com>"
